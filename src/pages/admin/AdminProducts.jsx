          ...
          {filteredProducts.map((product) => {
            ...
            return (
              ...
              >
                ...
                {/* BOTTOM ROW — badges + actions, always consistent */}
        ...
        {deleteTarget && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-sm rounded-2xl border border-transparent bg-white p-6 shadow-xl dark:border-gray-800 dark:bg-gray-900"
            >
